...
## Environments
- Preview: https://main--eds-ac-beaconmedaes--nielsd-organisation.aem.page/
- Live: https://main--eds-ac-beaconmedaes--nielsd-organisation.aem.live/
...
1. Open the `eds-ac-beaconmedaes` directory in your favorite IDE and start coding :)
